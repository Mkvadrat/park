...
?>
    ...
    <div class="wrapper">
                ...
                if ($gallery_image) {
                    foreach ($gallery_image as $image) {
                        ...
                        <div class="bg__slider"
                             style="background-image: url('<?php echo nextgen_esc_url($image->imageURL); ?>')">
                            <div class="slider__description">
                                <div class="slider__text">
                                    <h3><?php echo $image->alttext; ?><?php echo htmlspecialchars_decode($image->description, ENT_QUOTES); ?></h3>
                                </div>
                            </div>
                        </div>
                        <?php
        ...
        <div class="section__img">
            <div class="bg__img" data-parallax="scroll"
                 data-image-src="<?php echo $block_a['image_a_b_subblock_main_page']['url']; ?>">
                    ...
                    <?php foreach ($rooms as $room) { ?>
                        ...
                        <a href="<?php echo get_permalink($room->ID); ?>" class="room__item">
                            <div class="room__item-inner">
                                <div class="bg__room"
                                     style="background-image: url('<?php echo $image_url[0] ? $image_url[0] : esc_url(get_template_directory_uri()) . '/img/no_image.jpg' ?>')"></div>
        ...
        <div class="section__img">
            <div class="bg__img" data-parallax="scroll"
                 data-image-src="<?php echo $block_c['image_a_subblock_main_page']['url']; ?>">
        ...
        <div class="section__img">
            <div class="bg__img" data-parallax="scroll"
                 data-image-src="<?php echo $block_e['image_a_subblock_main_page']['url']; ?>">
        ...
        <div class="section__half">
            ...
            <div class="grid__half">
                <div class="img__half"><img src="<?php echo $block_f['image_a_subblock_main_page']['url']; ?>" alt="">
                </div>
        ...
        <div class="section__why">
            ...
            <div class="grid__why" data-parallax="scroll"
                 data-image-src="<?php echo $block_h['image_a_subblock_main_page']['url']; ?>">
                <div class="why__item">
        ...
        <div class="section__img section__testimonials">
            <div class="bg__img" data-parallax="scroll"
                 data-image-src="<?php echo $block_j['image_a_subblock_main_page']['url']; ?>">
        ...
        <!--<div class="footer__carousel">
            ...
            ?>
            <div class="inst-link-block"><a href="#" class="inst-link">Подписывайтесь на инстаграм отеля</a></div>
        </div>-->
